...
- Python based framework for submitting test jobs for CERN Monte Carlo requests using [HTCondor] and analyzing the output logs: (https://github.com/htcondor/htcondor): [mcmtest](https://github.com/alpakpinar/mcmtest)
